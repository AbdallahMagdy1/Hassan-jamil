        ...
        ? AnnotatedRegion<SystemUiOverlayStyle>(
            ...
            value: SystemUiOverlayStyle(
              systemNavigationBarColor: themeModeValue == 'dark'
                  ? Colors.black
                  : Colors.white,
              systemNavigationBarIconBrightness: themeModeValue == 'datrk'
                  ? Brightness.light
                  : Brightness.dark,
              statusBarColor: themeModeValue == 'dark'
                  ? darkColor
                  : Colors.white,
              statusBarIconBrightness: themeModeValue == 'datrk'
                  ? Brightness.light
                  : Brightness.dark,
            ),
            child: SafeArea(
              ...
              child: Stack(
                children: [
                  ...
                  Padding(
                    padding: EdgeInsets.only(top: widget.isStandalone ? 0 : 79),
                    child: Obx(
                      () => Visibility(
                        ...
                        child: InAppWebView(
                          ...
                          onWebViewCreated: (InAppWebViewController controller) {
                            ...
                            controller.addJavaScriptHandler(
                              ...
                              callback: (args) {
                                debugPrint(
                                  "Received appReady signal from React",
                                );
                                _showWebView();
                              },
                            );
                          ...
                          shouldOverrideUrlLoading: (controller, navigationAction) async {
                            ...
                            if (urlStr.contains('/shareLink/')) {
                              var urlShare = urlStr.replaceAll(
                                '/shareLink/',
                                '',
                              );
                          ...
                          onGeolocationPermissionsShowPrompt:
                              (
                                ...
                                try {
                                  ...
                                  debugPrint(
                                    'Geolocation permission error: $e',
                                  );
                                  return GeolocationPermissionShowPromptResponse(
                                    origin: origin,
                                    allow: false,
